...
const Messenger = () => {
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative', background: '#EDEDED', borderRadius: 20, overflow: 'hidden' }}>
      ...
      <div style={{ ...commonStyles, width: 138, height: 16, left: 145, top: 75, color: 'black', fontSize: 16, fontWeight: '200' }}>
        @daypessotti
      </div>

      <div style={{ ...commonStyles, width: 24, height: 24, left: 436, top: 55 }}>
        <div style={{ ...commonStyles, width: 18, height: 19.5, left: 3, top: 2.25, background: 'black' }}></div>
        <div style={{ ...commonStyles, width: 8, height: 8, left: 15, top: 0, background: '#B20000', borderRadius: '50%' }} />
      </div>

      <div style={{ ...commonStyles, width: 393, height: 71, left: 68, top: 203, background: '#EDEDED', borderRadius: 20 }} />

      <div style={{ ...commonStyles, width: 908, height: 104, left: 514, top: 883, background: 'white', borderRadius: 20 }} />
      <div style={{ ...commonStyles, width: 906, height: 104, left: 514, top: 27, background: 'linear-gradient(90deg, #FC4638 0%, #2CBAE2 100%)', borderRadius: 10 }} />
      <div style={{ ...commonStyles, width: 155, height: 59, left: 902, top: 174, background: 'rgba(44, 186, 226, 0.79)', borderRadius: 10 }} />

      <div style={{ ...commonStyles, width: 368, height: 49, left: 628, top: 920, color: 'black', fontSize: 30, fontWeight: '100' }}>
        Digite uma mensagem
      </div>

      <div style={{ ...commonStyles, width: 49, height: 46, left: 1244, top: 912 }}>
        <div style={{ ...commonStyles, width: 40.83, height: 38.33, left: 4.08, top: 3.83, background: 'rgba(0, 0, 0, 0.47)' }}></div>
      </div>

      <div style={{ ...commonStyles, width: 84, height: 80, left: 1311, top: 895 }}>
        <div style={{ ...commonStyles, width: 70, height: 66.67, left: 7, top: 6.67, background: '#2CBAE2' }}></div>
      </div>

      <div style={{ ...commonStyles, width: 222, height: 13, left: 84, top: 149, color: 'black', fontSize: 25, fontWeight: '700' }}>
        Mensagens
      </div>

      <div style={{ ...commonStyles, width: 222, height: 32, left: 184, top: 339, color: 'black', fontSize: 19, fontWeight: '500' }}>
        Emily
      </div>

      <div style={{ ...commonStyles, width: 222, height: 32, left: 184, top: 365, color: 'black', fontSize: 15, fontWeight: '100' }}>
        Olá🌼 Boa tarde....
      </div>

      <div style={{ ...commonStyles, width: 19, height: 19, left: 414, top: 341, fontSize: 15 }}>
        5s
      </div>
      ...
      <div style={{ ...commonStyles, width: 222, height: 32, left: 184, top: 485, color: 'black', fontSize: 19, fontWeight: '500' }}>
        Caio
      </div>

      <div style={{ ...commonStyles, width: 222, height: 32, left: 511, top: 773, color: 'black', fontSize: 15, fontWeight: '100' }}>
        📸 Olha essa nova foto do produto....
      </div>

      <div style={{ ...commonStyles, width: 30, height: 32, left: 410, top: 771 }}>
        <div style={{ ...commonStyles, width: 23.44, height: 13, left: 3.28, top: 11.5, border: '1.50px rgba(74, 74, 74, 0.48) solid' }}></div>
      </div>
      ...
      <div style={{ ...commonStyles, width: 487, height: 137, left: 544, top: 287 }}>
        ...
        <div style={{ ...commonStyles, width: 60, height: 16, left: 107, top: 109, color: 'black', fontSize: 12, fontFamily: 'Open Sans', fontWeight: '300' }}>
          3:17 PM
        </div>
      </div>
      ...
      <div style={{ ...commonStyles, width: 470, height: 129, left: 945, top: 433 }}>
        ...
        <div style={{ ...commonStyles, width: 60, height: 16, left: 15, top: 107, color: 'black', fontSize: 12, fontFamily: 'Open Sans', fontWeight: '300' }}>
          3:25 PM
        </div>
      </div>
